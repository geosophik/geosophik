...
- **Digital Products** — open-source mapping tools, spatial databases, and web applications.
- **Infrastructure** — systems for collecting and sharing spatial data, including GPS networks, sensors, and drones.
- **Education** — courses, workshops, and training in geospatial skills.
...
[geosophik.org](https://geosophik.org/)
